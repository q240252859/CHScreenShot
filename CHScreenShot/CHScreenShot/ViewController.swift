...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        button1.addTarget(self, action: #selector(self.leftButton(sender:)), for: UIControl.Event.touchUpInside)
        ...
        button2.addTarget(self, action: #selector(self.rightButton(sender:)), for: UIControl.Event.touchUpInside)
